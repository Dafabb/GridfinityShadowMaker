...
chamfer_height = 3;      // mm, height of chamfer
...
text_content = "TEK 16010";
border_text_size = 7; // [4:1:14]
text_x = 110.0; // [-200:1:200]
text_y = 30.0; // [-200:1:200]
text_rotation = 180; // [0:90:360]

/* [Section Adjustments] */
use_section_cut = false; // true or false
section_cut_depth_1 = [20, 15, 10];
section_parameters_1 = [40, 0, 0];
section_cut_depth = [section_cut_depth_1];
section_parameters = [section_parameters_1];
